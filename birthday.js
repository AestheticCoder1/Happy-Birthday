$(document).ready(function () {
  ...
  var tween = TweenMax.to(".scene-1 .text-bottom", 1, {
    opacity: 1,
  ...
  tl = new TimelineLite();
  var tween = tl
    .to(".flour", 1, { rotation: -70, ease: Linear.easeNone })
  ...
  var tween = TweenMax.to(".blender>.handle", 1, {
    rotation: 360,
    ease: Linear.easeNone,
  });
  var scene = new ScrollScene({
  ...
  var tween = TweenMax.to(".pan-with-batter", 1, {
    scale: 0.6,
    y: 200,
    ease: Linear.easeNone,
  });
  var scene = new ScrollScene({
    ...
    .setTween(tween)
    .setPin(".pan-with-batter")
    .addTo(controller);

  var tween = TweenMax.fromTo(
    ".cake",
    1,
    { opacity: 0.2, scale: 0.6, y: 0, ease: Linear.easeNone },
    { opacity: 1, scale: 1, y: 820, ease: Linear.easeNone }
  );
  var scene = new ScrollScene({
  ...
  var tween = TweenMax.fromTo(
    ".hbd",
    1,
    { opacity: 0.2, scale: 1.1, ease: Linear.easeNone },
