      ...
      function (t, e) {
        ...
        var ve,
          ...
          Ae = (function () {
            var t,
              e,
              i,
              s = f || (/Android/i.test(X) && !window.chrome);
            return (
              E.createElementNS &&
                !s &&
                ((t = ke("svg", Re)),
                ...
                (e.style[xe] = "50% 50%"),
                (e.style[Te] = "scale(0.5,0.5)"),
                (s = i === e.getBoundingClientRect().left),
                Re.removeChild(t)),
              s
            );
          })(),
          ...
          Oe = (N.getTransform = function (t, e, i, s) {
            ...
            var n,
              ...
              P = b * M,
              S = be
                ? parseFloat(W(t, xe, e, !1, "0 0 0").split(" ")[2]) ||
                  y.zOrigin ||
                  0
                : 0,
            ...
            if (
              (Te
                ? (n = W(t, we, e, !0))
                : t.currentStyle &&
                  ((n = t.currentStyle.filter.match(C)),
                  (n =
                    n && 4 === n.length
                      ? [
                          n[0].substr(4),
                ...
                if (
                  ...
                  (y.rotationX = J * z),
                    ...
                    j && te
                      ...
                      : Y && te && (y.rotationY = y.rotationX = 0),
                    (y.scaleX = (0 | (Math.sqrt(B * B + q * q) * x + 0.5)) / x),
                    (y.scaleY = (0 | (Math.sqrt(Q * Q + A * A) * x + 0.5)) / x),
                    (y.scaleZ = (0 | (Math.sqrt($ * $ + O * O) * x + 0.5)) / x),
                    (y.skewX = 0),
            ...
            return (
              ...
              y.svg &&
                (Ce(t, W(t, xe, r, !1, "50% 50%") + "", y),
                (ve = a.useSVGTransformAttr || Ae)),
          ...
          Me = (N.set3DTransformRatio = function (t) {
            ...
            if (R || S.skewX)
              ...
              if (!(S.rotationY || S.rotationX || 1 !== O || E || S.svg))
                return (
                  (k[Te] =
            ...
            (u = 1),
              ...
              S.svg &&
                ((r += S.xOrigin - (S.xOrigin * e + S.yOrigin * i)),
          ...
          "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent",
          {
            parser: function (t, e, i, s, n, o, h) {
              ...
              var l,
                ...
                f,
                m,
                d = (s._transform = Oe(t, r, !0, h.parseTransform)),
                g = t.style,
                v = 1e-6,
                y = ye.length,
                T = h,
              ...
              for (
                be && null != T.force3D && ((d.force3D = T.force3D), (f = !0)),
              ...
              return (
                ...
                f &&
                  (s._transformType =
                    (d.svg && ve) || (!c && 3 !== this._transformType) ? 2 : 3),
                n
              );
            },
            prefix: !0,
        ...
        (h = a.prototype),
          ...
          (h._onInitTween = function (t, e, o) {
            ...
            if (
              ...
              (y = new pe(t, "transform", 0, 0, null, 2)),
                ...
                (y.setRatio = T && be ? Me : Te ? ze : De),
                (y.data = this._transform || Oe(t, r, !0)),
                n.pop();
            }
            if (i) {
              for (; p; ) {
          ...
          (h._enableTransforms = function (t) {
            (this._transform = this._transform || Oe(this._target, r, !0)),
              (this._transformType =
        ...
        var Xe = function (t, e, i) {
          var s, r, n, a;
          if (t.slice) for (r = t.length; --r > -1; ) Xe(t[r], e, i);
          else
        ...
        (n._initProps = function (e, i, s, r) {
          ...
          for (n in this.vars) {
            if (((_ = this.vars[n]), U[n]))
              ...
              L[n] &&
              (h = new L[n]())._onInitTween(e, this.vars[n], this)
            ) {
              for (
                this._firstPT = l = {
                  _next: this._firstPT,
